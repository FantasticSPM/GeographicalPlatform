  ...
  <main class="register-page">
    ...
    <div class="register-layout">
      <section class="intro">
        ...
        <p class="intro__coordinates">
          31°14′N&nbsp;&nbsp; 121°29′E&nbsp;&nbsp; / &nbsp;&nbsp;DISCOVER MORE
        </p>
      </section>
      ...
      <section class="register-panel">
        ...
        >
          ...
          <div class="login-prompt">
            <span>已有账号？</span>
            <RouterLink class="login-link" :to="loginLocation"
              >立即登录</RouterLink
            >
          </div>
        </el-form>
...
import { apiRegister } from "@/apis/backend/auth";
...
const loginLocation = computed(() => {
  const rawUrl = Array.isArray(route.query.url)
    ? route.query.url[0]
    : route.query.url;
  return rawUrl ? { name: "login", query: { url: rawUrl } } : { name: "login" };
});
